...
(function(process){
    ...
    startup.EV = function() {
        ...
        EV.error = function(pointer,data){
            //we have error, emit error
            setEvent(function(){ _EV[pointer].emit('error',data);clearEvent(this)});
        };
    ...
    process.MakeCallback = function (object,callback,args,module){
        ...
        //} catch(e){
        //    process.traceError(e,module.filename,module);
        //}
